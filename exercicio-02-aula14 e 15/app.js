...
const allEpisodes = 'O nº de episódios é: NUMERO_DE_EPISÓDIOS'; // ou 'O nº de episódios é: ' + episodes;
...
const bookMessage = `'O Conto da Aia' é um dos livros mais vendidos da década.'`; // ou '\'O Conto da Aia\' é um dos livros mais vendidos da década.'
...
//console.log(newName.toUpperCase().replace('ALTER', 'alter').replace('HITE', 'hite'));
